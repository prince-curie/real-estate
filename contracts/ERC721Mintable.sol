...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, 'Only the contract owner is allowed');
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(address(0) != newOwner, 'Contract addresses are not allowed to make a call');
        _owner = newOwner;
        emit TransferOwnership();
    }
}
...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused == true, 'Contract has not been paused');
        _;
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, 'Address is the owner of the token');
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        if(msg.sender != contractOwner || _operatorApprovals[contractOwner][msg.sender] == false) {
            revert('You are not approved to make an approval');
        }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to.isContract() == false, 'Address is invalid.');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to.isContract() == false, 'Token is been transfered to an invalid address');
        // TODO: clear approval
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        string memory tokenIdInString = usingOraclize.uint2str(tokenId);
        string memory tokenURIString = usingOraclize.strConcat(_baseTokenURI, tokenIdInString);
...
contract CustomERC721Token is 
    Ownable,  
    ERC721Metadata('Curie', 'Cur', 'https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/')
    {
